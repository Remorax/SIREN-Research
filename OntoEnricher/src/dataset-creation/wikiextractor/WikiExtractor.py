...
# domains = ["pizza topping", "pizza toppings", "garlic bread", "pepperoni pizza", "meat pizza"]
topics = open("../wikiTopics.txt").read().split("\n")
...
def keepPage(ns, catSet, page, title):
    ...
    # for line in page:
    #     if any([el in line.lower() for el in domains]):
    #         return True
...
class Extractor(object):
    ...
    def __init__(self, id, revid, title, lines):
        ...
        self.frame = Frame()
        self.titlesFile = open("../infosec_topics.txt", "w+")
        # self.titlesFile = open("../pizza_entirewordList", "a+")
    ...
    def extract(self, out):
        ...
        # from zwChan
        self.titlesFile.write(title_str)
