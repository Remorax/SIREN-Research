...
declare -a path_thresholds=( 7) # Different frequencies considered while creating frequent paths
declare -a maxlens=(10 ) # Maximum path lengths considered while extracting paths
